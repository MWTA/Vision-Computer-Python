...
# Input image - 
def loadImg():
    img_orig = cv2.imread('../src/img/input/01.jpg', 0)
...
def step_03_04(img, sigma):
    ...
    img_edged = cv2.Canny(img, 50, 150)
...
'''
def step_05(img_orig):

    img = cv2.imread('../src/img/output/img_edged.png')
    ...
    cv2.imshow('Step 05 - Template Matching', result)
